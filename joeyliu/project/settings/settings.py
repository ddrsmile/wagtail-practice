...
with open('/usr/local/etc/NEVERCACHE_KEY') as f:
    NEVERCACHE_KEY = f.read().strip()
...
DATABASES = {
    "default": {
        ...
        "USER": "joeyliu",
        "PASSWORD": "joeyliu",
        "HOST": "joeyliu-db.cakqw0frva2e.ap-northeast-1.rds.amazonaws.com",
        "PORT": "3306",
    }
}
...
if os.path.exists(f):
    import sys
    import imp
    module_name = "{}.dev".format(PROJECT_APP)
